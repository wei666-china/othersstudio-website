        ...
        <FadeIn>
          <div className="grid grid-cols-1 lg:grid-cols-[1.3fr_1fr] bg-white rounded-2xl overflow-hidden border border-brown-light/20 hover:shadow-[0_16px_48px_rgba(61,43,31,0.1)] hover:-translate-y-0.5 transition-all cursor-pointer">
            ...
            <div className="p-10 lg:p-12 flex flex-col justify-center">
              <span className="inline-block px-3.5 py-1 bg-accent-soft text-accent rounded-full text-xs font-semibold mb-4 w-fit">{pinnedArticle.tag}</span>
              <h2 className="text-2xl lg:text-3xl mb-4 leading-snug">{pinnedArticle.title}</h2>
              <p className="text-sm text-brown-muted leading-relaxed mb-6">{pinnedArticle.excerpt}</p>
